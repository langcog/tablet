...
%   \hline
% (Intercept) & 7.54 & 0.06 & 133.03 \\ 
%   trial.number & -0.00 & 0.00 & -2.03 \\ 
%   factor(age.group)2 & -0.05 & 0.07 & -0.74 \\ 
%   factor(age.group)3 & -0.19 & 0.07 & -2.78 \\ 
%   factor(age.group)4 & -0.26 & 0.07 & -3.91 \\ 
%   trial.typeMEcontrol & 0.08 & 0.06 & 1.40 \\ 
%   trial.typeMEexperimental & -0.03 & 0.06 & -0.41 \\ 
%   factor(age.group)2:trial.typeMEcontrol & -0.11 & 0.07 & -1.58 \\ 
%   factor(age.group)3:trial.typeMEcontrol & -0.12 & 0.06 & -1.80 \\ 
%   factor(age.group)4:trial.typeMEcontrol & -0.13 & 0.07 & -2.01 \\ 
%   factor(age.group)2:trial.typeMEexperimental & 0.25 & 0.07 & 3.39 \\ 
%   factor(age.group)3:trial.typeMEexperimental & 0.26 & 0.07 & 3.75 \\ 
%   factor(age.group)4:trial.typeMEexperimental & 0.29 & 0.07 & 4.19 \\ 
%    \hline
% \end{tabular}
% \end{table}
