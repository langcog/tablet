...
While relatively little published research has made use of novel tablet-based tasks, there is an extensive literature that uses touch-screen computing 

Increasingly, publishers of standardized psychological instruments are creating tablet-specific versions of what used to be paper-and-pencil assessments. At time of writing, a number of instruments, including the WAIS \cite{wechsler2008}, CELF \cite{wiig2004}, PPVT \cite{dunn2007}, and many others are available from commercial publishers. 
