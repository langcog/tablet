...
Although tablets are becoming increasingly common in research, relatively little published research has compared them directly with other data collection modalities. One exception to this statement, however, is the use of tablets in standardized psychological instruments. Publishers are increasingly creating tablet-specific versions of what used to be paper-and-pencil assessments; at time of writing, a number of instruments, including the WAIS \cite{wechsler2008}, CELF \cite{wiig2004}, PPVT \cite{dunn2007}, and many others are available from commercial publishers. The tablet modality assists experimenters and facilitates response logging, and the change in the paradigm is minimal. Thus, tablets can be used effectively for data collection with children, at least for preschoolers and older children in relatively straightforward and standardized paradigms. 
...
The accuracy of young children's motor control poses a concern about their performance using tablets. Experience likely plays a substantial role in modulating the accuracy of tablet interactions, especially for the toddlers and early preschoolers, and some gestures are easier than others. \citeA{aziz2014} tested 2- to 5-year-olds in Malaysia and the United Kingdom on their ability to perform the seven most common touch gestures of iPads: tap, drag/slide, free rotate, drag and drop, pinch, spread, and flick. By age 2, children mastered the tap and drag/slide gestures, and by age 3, they could reliably produce all by the spread gesture. By age 4, all children performed all of the gestures. Our experiences confirm that even 1.5 -- 2-year-olds are able to learn to tap targets without too much difficulty, though more sophisticated gestures may be beyond them. 

While relatively little published research has made use of novel tablet-based tasks, there is an extensive literature that has used lab-based touch screen paradigms with children \cite<e.g.>{friend2003,holloway2008, sage2015}. This prior literature is important for calibrating our expectations about what paradigms may be ported successfully to tablets. Nevertheless, there are several differences between these touch screen paradigms and tablets. First, touch screen paradigms are often conducted with relatively specialized equipment in a lab setting, while tablets can be used anywhere. Second, tablets are small enough to be held by the child, and generally require small motor movements; in contrast, touchscreens are typically on a desk or mounted on a wall and may require a full arm movement (potentially leading to fatigue over a longer testing session). Third, the increasing comfort and proficiency of even young children with tablets may lead them to be more comfortable with experiments conducted in this medium, in turn leading to better data. Thus, not all insights from touch screen studies can be directly ported to tablet experiments. 

In sum, tablets are extremely engaging to children, but designers of experiments for young children should take care to consider appropriate content and gesture capabilities for their target age group. 
...
\item Tablet-based experiments require some technical expertise to implement and hence can be slower for initial piloting than traditional behavioral methods. 
